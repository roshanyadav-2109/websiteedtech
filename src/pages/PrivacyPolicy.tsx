      ...
      <main className="pt-20">
        <section className="bg-gradient-to-r from-royal to-royal-dark text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Privacy Policy for UNKNOWN IITIANS</h1>
            <p className="text-lg text-red-400 font-semibold mb-6">⚠️ Important Notice: By using this website, you agree to our Privacy Policy and Terms of Use. Please review our Privacy Policy to understand how we collect, use, and protect your personal information. Unauthorized use of our materials is prohibited.</p>
            <p className="text-sm text-gray-300">Effective Date: 01 January 2025</p>
          </div>
        </section>
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <h2>9. Copyright and Unauthorized Use of Materials</h2>
              <p>
              ...
              <p>
                ...
                Email: <a href="mailto:help.unknowniitians@gmail.com">help.unknowniitians@gmail.com</a>
              </p>
              <p>
