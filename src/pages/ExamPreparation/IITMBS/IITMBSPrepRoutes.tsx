...
const IITMBSPrepLayout: React.FC = () => {
  return (
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 p-6 rounded-lg">
          ...
          <Link
            to="/exam-preparation/iitmbs/notes"
        ...
        <div className="bg-green-50 p-6 rounded-lg">
          ...
          <Link
            to="/exam-preparation/iitmbs/branch"
        ...
        <div className="bg-purple-50 p-6 rounded-lg">
          ...
          <Link
            to="/exam-preparation/iitmbs/level"
...
const IITMBSPrepRoutes: React.FC = () => {
  return (
    <Routes>
      <Route path="/" element={<IITMBSPrepLayout />}>
        <Route index element={<IITMBSPrepHome />} />
