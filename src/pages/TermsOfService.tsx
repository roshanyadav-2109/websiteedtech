      ...
      <main className="pt-20">
        <section className="bg-gradient-to-r from-royal to-royal-dark text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">Terms and Conditions for UNKNOWN IITIANS</h1>
            <p className="text-lg text-gray-300">Welcome to UNKNOWN IITIANS ("we," "us," or "our"). These Terms and Conditions govern your access and use of our website ("Site"). By using our Site, you agree to comply with these Terms and Conditions. If you do not agree with any part of these terms, please refrain from using our services.</p>
          </div>
        </section>
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <h2>4. Paid Services and Payment Policy</h2>
              <p>
              ...
              <h3>Shipping Policy (Batch Access):</h3>
              <p>
              ...
              <h2>5. User-Generated Content and Contributions</h2>
              <p>
              ...
              <h2>6. Privacy Policy and Data Protection</h2>
              <p>
