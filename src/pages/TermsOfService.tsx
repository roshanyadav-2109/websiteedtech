    ...
    <>
      ...
      <main className="pt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Terms and Conditions for UNKNOWN IITIANS</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. General Use of the Website</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. User Accounts and Responsibilities</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Paid Services and Payment Policy</h2>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 my-6">
                <h3 className="text-lg font-semibold text-red-800 mb-2">Cancellation Policy:</h3>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 my-6">
                <h3 className="text-lg font-semibold text-blue-800 mb-2">Shipping Policy (Batch Access):</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. User-Generated Content and Contributions</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Privacy Policy and Data Protection</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Limitation of Liability and Disclaimer of Warranties</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Modifications to Terms and Conditions</h2>
              <p className="text-gray-700 leading-relaxed">
